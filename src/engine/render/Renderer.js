...
export class Renderer {
  constructor(canvas, board, traceInput) {
    ...
    this.pieceRenderer = new PieceRenderer(this.ctx);
  ...
  render() {
    ...
    this.pieceRenderer.render(this.board.getAllPieces(), this.traceInput.selectedPieceId);
    if (this.shockwaveGenerator) {
      this.effectsRenderer.renderShockwaves(this.shockwaveGenerator.getActive());
    }
    this.hudRenderer.render(this.turnNumber, this.currentPlayer, this.scores);
  }
